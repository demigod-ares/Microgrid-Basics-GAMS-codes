...
Equation RampUp(i,t), RampDn(i,t), costThermalcalc, balance(t), EMcalc;
costThermalcalc.. costThermal =e= sum((t,i),gendata(i,'a')*sqr(p(i,t))+gendata(i,'b')*p(i,t)+gendata(i,'c'));
*** Ramp up, Ramp down
RampUp(i,t).. p(i,t+1)-p(i,t) =l= gendata(i,'RU0');
RampDn(i,t).. p(i,t-1)-p(i,t) =l= gendata(i,'RD0');
...
Display p.l, costThermal.l, EM.l;

***ESS allocation using DC-OPF GAMS code for IEEE Reliability test 24-bus network
Set bus/1*24/, slack(bus)/13/, Gen/g1*g12/, t/t1*t24/;
Scalar Sbase/100/, VOLL/10000/, VOLW/50/, Nmax/15/;
Alias (bus,node);
...
Equation const1, const2, const3, const4, const5, const6, constESS, constESS2, constESS3, constESS4, constESS5, constESS6;
...
NESS.up(bus)=5; SOCMax(bus)=20; SOC0(bus)=0.2*SOCMax(bus)/sbase;
Model loadflow / all /;

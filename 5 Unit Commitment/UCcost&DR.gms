*** Cost-based unit commitment considering demand response / Demand Flexibility Constraints
Set
   t 'time'               / t1*t24 /
...
Table dataLP(t,*)
   ...
   t23  20.50   915
   t24  15.62   834;
dataLP(t,'load') = dataLP(t,'load')*0.45;
Parameter unit(i,char); unit(i,'ch1')=24;
...
Positive Variable pu(i,t), p(i,t), STC(i,t), SDC(i,t), Pk(i,t,k), D(t);
Binary Variable u(i,t), y(i,t), z(i,t);
p.up(i,t)    = gendata(i,"Pmax"); p.lo(i,t)=0;
Pk.up(i,t,k) = data(k,i,'DP'); Pk.lo(i,t,k)=0;
*** Can't you see a redundant code just below & a line above.
p.up(i,t)    = gendata(i,"Pmax"); pu.up(i,h)=gendata(i,"Pmax");
Equation Uptime1, Uptime2, Uptime3, Dntime1, Dntime2, Dntime3, Ramp1, Ramp2, Ramp3, Ramp4,
   startc, shtdnc, genconst1, Genconst2, Genconst3, Genconst4, balance, DRconst;
...
balance(t).. sum(i,p(i,t)) =e= D(t);
DRconst.. sum(t,dataLP(t,'load')) =e= sum(t,D(t));
Model UCLP /all/;
Option optCr = 0.0; D.up(t)=1.1*dataLP(t,'load'); D.lo(t)=0.9*dataLP(t,'load');

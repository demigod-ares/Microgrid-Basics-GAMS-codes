*** Unit commitment considering generator contingencies / outage
Set
   t 'time'               / t1*t24 /
   ...
   char                   / ch1*ch2 /
   g(i)                   / g1*g3,g5*g10 /;
*  set of generator outage contains each except g4
Alias (t,h);
...
*** Where the fuck are the reserve constrains???
Equation Uptime1, Uptime2, Uptime3, Dntime1, Dntime2, Dntime3, Ramp1, Ramp2, Ramp3, Ramp4,
   startc, shtdnc, genconst1, Genconst2, Genconst3, Genconst4, balance, reserve;
...
reserve(t,g).. sum(i$(ord(i) <> ord(g)),pu(i,t)-p(i,t)) =g= 1*p(g,t);
Model UCLP /all/;
option optCr = 0.0;
